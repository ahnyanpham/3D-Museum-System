(function initDragonStation() {
    require([
         ...
         */
        function drawFloor(floor, floorHeigh, colHeight, wallHeight, isRoofTop, isFirstFloor, isDrawStair, colNumFront, colNumRight) {
        ...
        function drawRoof(floorPoint1, floorPoint2, floorPoint3, floorPoint4, colmDistance1, colmDistance2, colmDistance3, colmDistance4, colWidth, floorHeigh, wallHeight) {
            ...
            let roofMidPoint1 = pointAtDistance(roofFootPoint1, roofFootPoint4, colmDistance4, roofHeight/2);
            let roofMidPoint2 = pointAtDistance(roofFootPoint2, roofFootPoint3, colmDistance2, roofHeight/2);
            let roofMidPoint3 = pointAtDistance(roofFootPoint3, roofFootPoint2, colmDistance2, roofHeight/2);
            let roofMidPoint4 = pointAtDistance(roofFootPoint4, roofFootPoint1, colmDistance4, roofHeight/2);
            let roofMidWidth1 = distance2D(roofMidPoint1, roofMidPoint4);
            let roofHeadPoint1 = pointAtDistance(roofMidPoint1, roofMidPoint4, roofMidWidth1/2, roofHeight);
            let roofMidWidth2 = distance2D(roofMidPoint2, roofMidPoint3);
            let roofHeadPoint2 = pointAtDistance(roofMidPoint2, roofMidPoint3, roofMidWidth2/2, roofHeight);
            ...
            meshItems.push({position: dragon1Point, path: "./3d-objects/dragon.glb", scale: 1, rotate: 295});
            meshItems.push({position: dragon2Point, path: "./3d-objects/dragon.glb", scale: 1, rotate: 116});
        }
        ...
        function loadNTTStatue(point) {
            ...
            meshItems.push({ position: position, path: "./3d-objects/tuong_nguyen_tat_thanh.glb", scale: 4.5, rotate: 238});// nguồn: https://sketchfab.com/3d-models/tuong-nguyen-tat-thanh-8da3fb1dd7084622a81560fb35f39d12
            // vẽ chân tượng
        ...
        */
        function drawCylinder(center, radius, height, color) {
            ...
            let content = `Central point: <br>&emsp; x: ${center[1]};<br>&emsp; y: ${center[1]};<br>&emsp; z: 0 <br>&emsp;radius${radius}<br>&emsp;height: ${height}`;
        ...
        function loadVisitPoints(points) {
            let tripPoints = [];
            let elements = [];
            points.forEach(point => {
                ...
                tripPoints.push(position);
                meshItems.push({ position: position, path: "./3d-objects/map_location_3d.glb", scale: 0.1, rotate: 238});// nguồn: https://sketchfab.com/3d-models/map-location-3d-23eb3bb4038b43c9995b675eb6ec5033
            });

            elements.push(document.getElementById("entrance"));
            document.getElementById("entrance").addEventListener('click', function(e) {
                ...
                showPopup(view, tripPoints[0], "Cổng vào", "Cổng vào Bến Nhà Rồng là điểm khởi đầu của hành trình tham quan Khu di tích lịch sử Bến Nhà Rồng. Nơi đây không chỉ đánh dấu lối vào một công trình kiến trúc mang đậm dấu ấn lịch sử mà còn gợi nhắc về sự kiện quan trọng gắn liền với cuộc đời và sự nghiệp của Chủ tịch Hồ Chí Minh. Từ cổng vào, du khách có thể cảm nhận được không gian trang nghiêm, cổ kính của khu di tích, mở ra hành trình tìm hiểu về quá trình hình thành, phát triển và giá trị lịch sử – văn hóa đặc biệt của Bến Nhà Rồng.");
            });
            elements.push(document.getElementById("fountain"));
            document.getElementById("fountain").addEventListener('click', function(e) {
                view.goTo({
                    target: tripPoints[1],
                    zoom: 23,
                    tilt: 65,
                ...
                showPopup(view, tripPoints[1], "Đài phun nước", "Điểm thăm quan thứ 2 là Đài phun nước Bến Nhà Rồng nằm trong khuôn viên Khu di tích lịch sử Bến Nhà Rồng, là điểm nhấn cảnh quan góp phần tạo nên không gian hài hòa, thoáng đãng cho toàn bộ khu vực tham quan. Không chỉ mang giá trị thẩm mỹ, đài phun nước còn đóng vai trò kết nối không gian giữa các hạng mục kiến trúc, giúp du khách có cảm giác thư giãn và dễ dàng dừng chân chiêm ngưỡng cảnh quan xung quanh. Sự hiện diện của đài phun nước góp phần làm nổi bật vẻ trang nghiêm nhưng gần gũi của Bến Nhà Rồng, tạo nên một điểm dừng chân ý nghĩa trong hành trình tìm hiểu về di tích lịch sử đặc biệt này.");
            });
            elements.push(document.getElementById("statute"));
            document.getElementById("statute").addEventListener('click', function(e) {
                view.goTo({
                    target: tripPoints[2],
                    zoom: 23,
                    tilt: 65,
                ...
                showPopup(view, tripPoints[2], "Tượng đài Nguyễn Tất thành", "Tượng đài Nguyễn Tất Thành tại Bến Nhà Rồng là điểm thăm quan thứ 3 là công trình mang ý nghĩa lịch sử và tinh thần sâu sắc, ghi dấu hình ảnh người thanh niên Nguyễn Tất Thành trong những ngày đầu ra đi tìm đường cứu nước. Tượng đài được đặt trong không gian trang trọng, hướng ra sông Sài Gòn, thể hiện ý chí, khát vọng và quyết tâm của Người đối với sự nghiệp giải phóng dân tộc. Đây không chỉ là điểm nhấn kiến trúc của khu di tích mà còn là nơi để du khách tưởng nhớ, tri ân và hiểu rõ hơn về bước ngoặt quan trọng trong cuộc đời Chủ tịch Hồ Chí Minh.");
            });
            elements.push(document.getElementById("museum"));
            document.getElementById("museum").addEventListener('click', function(e) {
                view.goTo({
                    target: tripPoints[3],
                    zoom: 22,
                    tilt: 70,
                ...
                showPopup(view, tripPoints[3], "Bảo tàng HCM", "<br/><button class='step' ><a href='https://bennharong.servehttp.com/public/floor-plans/'>Sơ đồ bảo tàng HCM</a></button>**Bảo tàng Hồ Chí Minh tại Bến Nhà Rồng** là không gian trưng bày có giá trị đặc biệt, nơi lưu giữ và giới thiệu những tư liệu, hình ảnh và hiện vật gắn liền với cuộc đời và sự nghiệp cách mạng của Chủ tịch Hồ Chí Minh. Bảo tàng được xây dựng ngay tại địa điểm lịch sử nơi Người ra đi tìm đường cứu nước năm 1911, mang ý nghĩa sâu sắc về lịch sử và giáo dục truyền thống. Thông qua hệ thống trưng bày khoa học và trực quan, bảo tàng giúp du khách hiểu rõ hơn về tư tưởng, đạo đức và tầm vóc của Chủ tịch Hồ Chí Minh, đồng thời góp phần tôn vinh và gìn giữ những giá trị lịch sử – văn hóa của dân tộc."
                        + "Không gian trưng bày của bảo tàng được bố trí trên **ba tầng**, mỗi tầng mang một nội dung và ý nghĩa riêng. **Tầng trệt** giới thiệu khái quát về thân thế, quê hương và bối cảnh lịch sử của Việt Nam cuối thế kỷ XIX – đầu thế kỷ XX, làm tiền đề cho hành trình ra đi tìm đường cứu nước của Nguyễn Tất Thành. **Tầng một** tập trung tái hiện quá trình hoạt động cách mạng của Chủ tịch Hồ Chí Minh ở trong và ngoài nước, thông qua các tư liệu, hình ảnh và hiện vật tiêu biểu. **Tầng hai** thể hiện tư tưởng, đạo đức và di sản của Người, đồng thời phản ánh giá trị và ý nghĩa trường tồn của tư tưởng Hồ Chí Minh đối với sự nghiệp xây dựng và bảo vệ Tổ quốc.");
            });
            elements.push(document.getElementById("diagram"));
            document.getElementById("diagram").addEventListener('click', async function(e) {
                
               window.open('https://bennharong.servehttp.com/public/floor-plans/', 'Sơ đồ bảo tàng HCM', "width=1800,height=900");
            });
            document.getElementById("auto").addEventListener('click', async function(e) {
                
                for (let i = 0; i < tripPoints.length; i++) {
                    elements[i].click();
                    await sleep(10000); // Pauses the function for 2 seconds
                };
                window.open('https://bennharong.servehttp.com/public/floor-plans/', 'Sơ đồ bảo tàng HCM', "width=1800,height=900");
            });
         ...
         * @param {* title of popup} title 
         * @param {* content of popup} content 
         */
        function showPopup(view, point, title, content) {
            view.popup.open({
                title: title,
                content: content,
                location: point
        ...
        getConsData();
        /**
         * call api to get data to draw map
         */
        function getConsData() {

            fetch("https://bennharong.servehttp.com/api/construct-and-trip-data", {
                method: "GET",
            ...
            .then(res => {
                if (res) {
                    if (res.construction && res.construction.length == 2) {
                        let museumCons = res.construction[0];
                        drawMuseum(museumCons);
                        let statueCons = res.construction[1];
                        drawStatue(statueCons);
                    }
                    if (res.trip && res.trip.length > 0) {
                        drawVisitPoint(res.trip);
                    }
                    renderCons();
                }
            })
        ...
        function drawMuseum(museumCons) {
            const floor1Height = museumCons.FLOOR_HEIGHT;
            const floor1Z = 0;
            const colHeight1 = museumCons.COLUMN_HEIGHT;
            const wallHeight1 = colHeight1;
            const floor1FirstPoint = [museumCons.COORDINATES[0].LONGITUDE, museumCons.COORDINATES[0].LATITUDE, museumCons.COORDINATES[0].ALTITUDE]// kinh độ, vĩ độ, độ cao

            const floor1SecondPoint = [museumCons.COORDINATES[1].LONGITUDE, museumCons.COORDINATES[1].LATITUDE, museumCons.COORDINATES[1].ALTITUDE];

            const floor1ThirdPoint = [museumCons.COORDINATES[2].LONGITUDE, museumCons.COORDINATES[2].LATITUDE, museumCons.COORDINATES[2].ALTITUDE];

            const floor1LastPoint = [museumCons.COORDINATES[3].LONGITUDE, museumCons.COORDINATES[3].LATITUDE, museumCons.COORDINATES[3].ALTITUDE];
            ...
            drawFloor(floor1, floor1Height, colHeight1, wallHeight1, false, true, true, museumCons.COL_NUM_FRONT, museumCons.COL_NUM_RIGHT);


            // Tầng 2 (nhỏ hơn)
            let floor2Height = floor1Height/4;
            const colHeight2 = colHeight1;
            ...
            drawFloor(floor2, floor2Height, colHeight2, wallHeight2, false, false, false, museumCons.COL_NUM_FRONT, museumCons.COL_NUM_RIGHT);

            let floor3Height = floor2Height;
            const colHeight3 = colHeight2/3;
            const wallHeight3 = wallHeight1;
            ...
            drawFloor(floor3, floor3Height, colHeight3, wallHeight3, true, false, false, museumCons.COL_NUM_FRONT, museumCons.COL_NUM_RIGHT);
        }

        /**
         * draw statue construction
         */
        function drawStatue(statueCons) {
            let statuePoint = [statueCons.COORDINATES[0].LONGITUDE, statueCons.COORDINATES[0].LATITUDE, statueCons.COORDINATES[0].ALTITUDE];
         ...
         * draw visit points 
         */
        function drawVisitPoint(visitPoints) {
            let entranceVisitPoint = [visitPoints[0].LONGITUDE, visitPoints[0].LATITUDE, visitPoints[0].ALTITUDE];
            let fountainVisitPoint = [visitPoints[1].LONGITUDE, visitPoints[1].LATITUDE, visitPoints[1].ALTITUDE];
            let statueVisitPoint = [visitPoints[2].LONGITUDE, visitPoints[2].LATITUDE, visitPoints[2].ALTITUDE];
            let museumVisitPoint = [visitPoints[3].LONGITUDE, visitPoints[3].LATITUDE, visitPoints[3].ALTITUDE];
            let points = [entranceVisitPoint, fountainVisitPoint, statueVisitPoint, museumVisitPoint];
            loadVisitPoints(points);
        }

        /**
         * render all object on map
         */
        function renderCons() {
        ...
        /**
         * event click to consolde out the position
         */
